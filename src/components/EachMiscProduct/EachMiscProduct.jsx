...
export class EachMiscProduct extends Component {
  constructor() {
    super();
    this.state = {
      qty: 1,
  ...
  componentDidMount() {
    ...
    this.props.displayTheProduct("misc", params.id);
    console.log(params);
  }
  ...
  render() {
    ...
    return (
      <div className='each-product-sec'>
        <Header2 />
        <div className="each-misc-product">
        ...
        <Link className='link-back-to-products' to="/shop/collections/misc">← Back to Misc</Link>
        <Footer2 />
      </div>
    );
  }
