...
export class Footwear extends Component {
  ...
  render() {
    ...
    let mappedFootwearProducts = this.props.products.listOfProducts.map((val, i)=>{return ( <Product className='each-product' key={val.product_id} id={val.product_id} type={val.type} image_url={val.image_url} title={val.title} price={val.price} />
 )})
    return (
      <div>
        <Header2 />
