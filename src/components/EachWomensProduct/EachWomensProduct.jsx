...
export class EachWomensProduct extends Component {
  ...
  componentDidMount() {
    ...
    this.props.displayTheProduct("womens", params.id);
    console.log(params);
  }
  ...
  render() {
    ...
    return (
      <div className='each-product-sec'>
        <Header2 />
        <div className="each-womens-product">
        ...
        <Link className='link-back-to-products' to="/shop/collections/womens">← Back to Womens</Link>
        <Footer2 />
      </div>
    );
  }
